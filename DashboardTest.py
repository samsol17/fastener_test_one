...
if df is None:
    ...
    with tab1:
        ...
        try:
            ...
            if pd.notna(titanium_price) and pd.notna(steel_price):
                ...
                st.warning(
                    "Could not calculate price gap. Ensure both Titanium and Steel products exist for this category.")
    ...
    with tab2:
        ...
        if filtered_df.empty:
            ...
            st.dataframe(
                product_df[['date_scraped', 'price_per_unit', 'inventory_level', 'daily_depletion_rate']].sort_values(
    ...
    with tab3:
        ...
        if steel_df.empty:
            ...
            if not steel_summary.empty:
                ...
                st.info(
                    "**Target Quadrant (Top-Right):** Products in this area are expensive (for steel) yet still sell fast. They represent the best opportunity for a premium titanium substitute.")